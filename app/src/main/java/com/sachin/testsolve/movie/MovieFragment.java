package com.sachin.testsolve.movie;
...
public class MovieFragment extends Fragment implements HomeRecyclerViewAdapter.OnItemClickListener,VideoInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        AppSingleton.getInstance().setVideoInterface(this);
        setAdapter();
        return view;
    }
