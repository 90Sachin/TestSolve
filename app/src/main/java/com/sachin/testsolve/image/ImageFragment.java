package com.sachin.testsolve.image;
...
public class ImageFragment extends Fragment implements HomeRecyclerViewAdapter.OnItemClickListener,ImageInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        AppSingleton.getInstance().setImageInterface(this);
        setAdapter();
        return view;
    }
